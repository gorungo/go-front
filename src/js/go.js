...
export const categoryParent = function (categories, category) {
  if (!category || category.attributes.parent_id === 0) {
    return null
  }
  return categories[categories.indexOf(category)]
}

export const categoryChildren = function (categories, category) {
  if (category === null) {
