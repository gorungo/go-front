        ...
        <div class="filter__content">
          <div>
            <div v-if="place === null" class="filter__input-wrap">
              <i>
                <img alt="start search" src="/images/icons/search.svg" width="32px"/>
              </i>
            ...
            <div v-if="place">
              ...
              <span class="filter__active-place-title">
                <img alt="nearby flag" src="/images/icons/flag.svg" width="32px"/>
            ...
            <ul v-if="!loading && !place" class="filter__list">
              <li v-if="!searchTitle.length">
                ...
                <span>
                  <img alt="nearby flag" class="icon" src="/images/icons/flag.svg" width="32px"/>
                  {{ $t('filter.nearby') }}
                </span>
                </button>
              </li>
