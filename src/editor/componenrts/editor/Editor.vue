      ...
      <div class="eb" @click="handleShowExamplesModalClick" :class="{ebh: !hasExamples}">
        <button type="button" class="wlymrds">
          <div class="hgs47m">
            <div class="ni9axhe">
              <div class="yl6"
                   style="width: 34px; height: 34px; background: rgb(0, 132, 137); color: rgb(255, 255, 255);">
                <svg viewBox="0 0 18 18" role="img" focusable="false"
                     style="height: 20px; width: 20px; display: block; fill: rgb(255, 255, 255);">
                  <path
                      d="m17 9c0-4.42-3.58-8-8-8s-8 3.58-8 8 3.58 8 8 8 8-3.58 8-8m1 0c0 4.97-4.03 9-9 9s-9-4.03-9-9 4.03-9 9-9 9 4.03 9 9m-9-5.25c-.69 0-1.25.56-1.25 1.25s.56 1.25 1.25 1.25 1.25-.56 1.25-1.25-.56-1.25-1.25-1.25m0 4.25c.55 0 1 .45 1 1v5c0 .55-.45 1-1 1s-1-.45-1-1v-5c0-.55.45-1 1-1"
...
export default {
  ...
  computed: {
    sidebarTitle() {
      return this.$t('editor.ideaEditor.title')
    },
    mainHeaderTitle() {
    ...
    ...mapState('IdeaEditor', ['isRecruiter', 'isMobile']),
    ...mapGetters('IdeaEditor', [
      'sections',
      'itemId',
      'item',
      'activeSection',
